...
<span class='input-group-text bg-white'style='border:none;border-bottom:1px solid lightgray;border-radius:0px;'><i class='icofont icofont-lock'></i></span>
         <input type="password" required name="pwd" class="form-control" placeholder="********">
                ...
                <div class="form-group input-group">
                    <span class='input-group-text bg-white'style='border:none;border-bottom:1px solid lightgray;border-radius:0px;'><i class='icofont icofont-lock'></i></span>
         <input type="password" required name="npwd" class="form-control" placeholder="********">
                </div>
         ...
         <input type="submit" name="save" class="btn btn-block btn-outline-light" value="Change password" style='  background-image:linear-gradient(to left,rgba(200,0,200,0.6),rgba(0,0,0,0.9));border-radius:100px;margin-top:2em;'>
    ...
    if(isset($_POST['save']))
    {
        ...
        if($pwd==$_POST['pwd'])
        {
            ...
            {
                $sql="update users set password='$_POST[npwd]'where userid='$_SESSION[uid]'";
