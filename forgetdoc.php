...
<div class="form-group input-group">
    ...
    if(isset($_POST['save']))
    {
        $sql="select * from doctors where email='$_POST[em]'";
...
$message='dear'.$_POST['em'].'use this code to reset your password:'.$code."<a href='http://localhost/dashboard/Mentallwellness/resetdoc.php?id=$em'>click here</a>to reset your account";
$mail=new PHPMailer;
$mail->isSMTP();
